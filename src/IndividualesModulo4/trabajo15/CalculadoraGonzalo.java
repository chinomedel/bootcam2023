 ...
 * @since 28-06-2022
 */
public class CalculadoraGonzalo {
    public static void main(String[] args) {
        ...
        do {
            ...
            poner el usuario, en la condicional tenemos primero que solo se admite los caracteres '+' y '-',
             pero con la condición de que sea una sola vez o ninguna vez. Después tenemos que se admiten cualquier
              número del 0 al 9 y que se ponga o 0 veces o más veces, es decir, se pone algo o no se pone nada.
